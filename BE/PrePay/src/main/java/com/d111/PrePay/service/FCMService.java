...
//                .fromStream(new ClassPathResource("src/main/resources/fcm-google-services.json").getInputStream())
                .fromStream(getClass().getResourceAsStream("/fcm-google-services.json"))
     ...
     */
    private String makeDataMessage(String targetToken, String title, String data) throws JsonProcessingException {
//        Notification noti = new FcmMessage.Notification(title, body, null);
     ...
     * @throws IOException
     */
    public void sendDataMessageTo(String targetToken, String title, String data) throws IOException {
        String message = makeDataMessage(targetToken, title, data);
